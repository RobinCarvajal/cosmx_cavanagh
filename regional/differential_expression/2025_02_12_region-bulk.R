...
# exclude cells from s1056pos and anterior_cingulate_area
brain<- subset(brain, subset = slice_position != "s1056pos" & 
                 regions.major != "anterior_cingulate_area")
