...
```{r}
out <- "F:/cosmx_data/broad_single_cell/upset_plots/condition/posterior"
filename <- file.path(out, "upset_plot_up.png")
# create dir
...
# getting all the genes corrresposing to the combiantions
...
Merge the combination celltypes with the combination genes df
...
```{r}
out <- "F:/cosmx_data/broad_single_cell/upset_plots/condition/posterior"
filename <- file.path(out, "combination_summary_up.tsv")
# create dir
if (!dir.exists(out)){dir.create(out, recursive = TRUE)}
