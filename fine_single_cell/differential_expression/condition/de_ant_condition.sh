...
# DATA PATHS
analysis_type="fine_single_cell" # type of analysis (e.g. single.cell, niches, celltypes, etc)
...
do
    ...
    --de  file="${celltypes_dir}/${celltype}/de_${celltype}.tsv",numerator="ant_A",denominator="ant_C" \
