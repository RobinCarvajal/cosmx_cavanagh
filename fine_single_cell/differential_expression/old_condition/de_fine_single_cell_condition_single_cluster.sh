...
# DATA PATHS
analysis_type="fine_single_cell" # type of analysis (e.g. single.cell, niches, regions, etc)
...
ss_dir="${de_dir}/ss/ss_immune4.tsv" # sample sheet path 
celltypes_dir="${de_dir}/cell_types" # celltypes dir

# celltype list
celltypes_list=("Immune.4")
