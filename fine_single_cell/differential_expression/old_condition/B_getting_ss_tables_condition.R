...
# just take any EM
em_path <- file.path(data_dir,"fine_single_cell","differential_expression",
                     "condition","cell_types","Astrocytes.0","em_Astrocytes.0.tsv")
...
# save path
out<-file.path(data_dir, "fine_single_cell","differential_expression", "condition", "ss")
