...
samples = c("S1055BS1_POS_C","S1055BS2_POS_C","S1056BS1_POS_C","S1056BS2_POS_C","S1055BS3_POS_A","S1055BS4_POS_A","S1056BS4_POS_A")
sample_groups = c("POS_C","POS_A")
sample_groups = factor(sample_groups, levels = sample_groups)
sample_groupings = c("POS_C","POS_C","POS_C","POS_C","POS_A","POS_A","POS_A")
sample_groupings = factor(sample_groupings, levels = sample_groups)
samples_by_sample_group = list(c("S1055BS1_POS_C","S1055BS2_POS_C","S1056BS1_POS_C","S1056BS2_POS_C"),c("S1055BS3_POS_A","S1055BS4_POS_A","S1056BS4_POS_A"))
...
```{r}
default_sample_labels = gsub("_"," ",c("S1055BS1_POS_C","S1055BS2_POS_C","S1056BS1_POS_C","S1056BS2_POS_C","S1055BS3_POS_A","S1055BS4_POS_A","S1056BS4_POS_A")) # note: changing this won't change the order the samples appear on the plots. Merely what they are labelled as.
...
default_samples_colours = c(default_sample_group_colours[1],default_sample_group_colours[1],default_sample_group_colours[1],default_sample_group_colours[1],default_sample_group_colours[2],default_sample_group_colours[2],default_sample_group_colours[2])
