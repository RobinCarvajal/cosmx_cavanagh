...
```{r}
wd <- list(
  agranular.insular.area = "F:/cosmx_data/regional/differential_expression/condition/anterior/agranular.insular.area/SL2_results/all_genes/de_workflows/ANT_A_vs_ANT_C",
  anterior.cingulate.area = "F:/cosmx_data/regional/differential_expression/condition/anterior/anterior.cingulate.area/SL2_results/all_genes/de_workflows/ANT_A_vs_ANT_C", 
  caudoputamen = "F:/cosmx_data/regional/differential_expression/condition/anterior/caudoputamen/SL2_results/all_genes/de_workflows/ANT_A_vs_ANT_C",
  motor.areas = "F:/cosmx_data/regional/differential_expression/condition/anterior/motor.areas/SL2_results/all_genes/de_workflows/ANT_A_vs_ANT_C",
  nucleus.accumbens = "F:/cosmx_data/regional/differential_expression/condition/anterior/nucleus.accumbens/SL2_results/all_genes/de_workflows/ANT_A_vs_ANT_C"
  )
...
for (region in names(scaled_matrix_tables)){
  ...
  # out path 
  out <- file.path(data_dir, "requests", "neurotransmission_genes_heatmaps", "anterior", region)
